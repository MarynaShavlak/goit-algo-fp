...
BFS — це черга з `popleft`, рівень за рівнем, тут усе прямолінійно. У DFS на стеку
...
а у BFS лягає горизонтальними шарами. Обидва обходи — O(n) за часом; стек тримає
