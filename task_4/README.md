...
цим правилом будуємо з масиву бінарне дерево й малюємо його.
...
Потрібні `networkx` і `matplotlib`. Зберегти обидва дерева у файли (так зроблено
`min_heap.png` і `max_heap.png`):
...
В обох випадках корінь — екстремум (мінімум або максимум), і це правило тримається
